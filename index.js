...
const successSound = new Audio('./ايه الحلاه ديه (mp3cut.net).mp3'); // Sound for correct match
const errorSound = new Audio('./فول الصين العظيم 👨‍🌾 يا جدع.mp3'); // Sound for incorrect match
